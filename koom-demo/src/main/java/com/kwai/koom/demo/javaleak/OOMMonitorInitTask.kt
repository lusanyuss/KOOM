...
object OOMMonitorInitTask : InitTask {
    ...
    override fun init(application: Application) {
        val config = OOMMonitorConfig.Builder().setThreadThreshold(50) //50 only for test! Please use default value!
            ...
            .setEnableHprofDumpAnalysis(true).setHprofUploader(object : OOMHprofUploader {
