...
std::string &GetDefaultTag() {
  static std::string default_tag = kwai_getprogname();
  return default_tag;
}
...
int32_t __android_log_get_minimum_priority() { return minimum_log_priority; }
...
void __android_log_set_logger(__android_logger_function logger) { logger_function = logger; }
...
void __android_log_set_aborter(__android_aborter_function aborter) { aborter_function = aborter; }

void __android_log_call_aborter(const char *abort_message) { aborter_function(abort_message); }
