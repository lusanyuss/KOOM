...
// warnings.
template<typename T>
constexpr T const_check(T value) { return value; }
...
class buffer {
 ...
 public:
  ...
  template<typename I>
  T &operator[](I index) { return ptr_[index]; }
  template<typename I>
...
constexpr size_t count() { return B ? 1 : 0; }
...
#if FMT_USE_INT128
	case detail::type::int128_type:return vis(arg.value_.int128_value);
	case detail::type::uint128_type:return vis(arg.value_.uint128_value);
#else
