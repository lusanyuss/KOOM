...
struct TypeHelper<ValueType, bool> {
  ...
  static ValueType &Set(ValueType &v,
						bool data,
						typename ValueType::AllocatorType &) { return v.SetBool(data); }
};
...
struct TypeHelper<ValueType, int> {
  ...
  static ValueType &Set(ValueType &v,
						int data,
						typename ValueType::AllocatorType &) { return v.SetInt(data); }
};
...
struct TypeHelper<ValueType, unsigned> {
  ...
  static ValueType &Set(ValueType &v,
						unsigned data,
						typename ValueType::AllocatorType &) { return v.SetUint(data); }
};
...
struct TypeHelper<ValueType, int64_t> {
  ...
  static ValueType &Set(ValueType &v,
						int64_t data,
						typename ValueType::AllocatorType &) { return v.SetInt64(data); }
};
...
struct TypeHelper<ValueType, uint64_t> {
  ...
  static ValueType &Set(ValueType &v,
						uint64_t data,
						typename ValueType::AllocatorType &) { return v.SetUint64(data); }
};
...
struct TypeHelper<ValueType, double> {
  ...
  static ValueType &Set(ValueType &v,
						double data,
						typename ValueType::AllocatorType &) { return v.SetDouble(data); }
};
...
struct TypeHelper<ValueType, float> {
  ...
  static ValueType &Set(ValueType &v,
						float data,
						typename ValueType::AllocatorType &) { return v.SetFloat(data); }
};
...
struct TypeHelper<ValueType, const typename ValueType::Ch *> {
  ...
  static ValueType &Set(ValueType &v,
						const StringType data,
						typename ValueType::AllocatorType &a) { return v.SetString(data, a); }
};
...
class GenericValue {
  ...
  */
  ...
  explicit GenericValue(T b,
						RAPIDJSON_ENABLEIF((internal::IsSame<bool,
															 T>))) RAPIDJSON_NOEXCEPT  // See #472
#else
  ...
  */
  ...
  RAPIDJSON_DISABLEIF_RETURN((internal::OrExpr<internal::IsPointer<T>,
											   internal::IsGenericValue<T> >), (bool)) operator==(
	  const T &rhs) const { return *this == GenericValue(rhs); }
  ...
  */
  template<typename T>
  RAPIDJSON_DISABLEIF_RETURN((internal::NotExpr<internal::IsSame<typename internal::RemoveConst<T>::Type,
																 Ch> >),
  ...
  GenericValue &AddMember(GenericValue &name, GenericValue &value, Allocator &allocator) {
	...
	if (o.size >= o.capacity) {
	  if (o.capacity == 0) {
		...
		SetMembersPointer(reinterpret_cast<Member *>(allocator.Malloc(
  ...
  */
  GenericValue &PushBack(GenericValue &value, Allocator &allocator) {
	...
	if (data_.a.size >= data_.a.capacity)
	  Reserve(data_.a.capacity == 0 ? kDefaultArrayCapacity : (data_.a.capacity
		  + (data_.a.capacity + 1) / 2), allocator);
  ...
  */
  ...
  ValueType &Set(const T &data, AllocatorType &allocator) {
	return internal::TypeHelper<ValueType,
								T>::Set(*this,
										data,
										allocator);
  }
  ...
  */
  ...
  bool Accept(Handler &handler) const {
	switch (GetType()) {
	  ...
	  case kStringType:
		return handler.String(GetString(),
							  GetStringLength(),
 ...
 private:
  ...
  RAPIDJSON_FORCEINLINE const Ch *GetStringPointer() const {
	return RAPIDJSON_GETPOINTER(Ch,
								data_.s.str);
  }
  ...
  RAPIDJSON_FORCEINLINE Member *GetMembersPointer() const {
	return RAPIDJSON_GETPOINTER(Member,
								data_.o.members);
  }
...
class GenericDocument : public GenericValue<Encoding, Allocator> {
 ...
 public:
  ...
  bool EndObject(SizeType memberCount) {
	typename ValueType::Member
		*members = stack_.template Pop<typename ValueType::Member>(memberCount);
...
class GenericArray {
 public:
  ...
  RAPIDJSON_DISABLEIF_RETURN((internal::OrExpr<internal::IsPointer<T>,
							 ...
							 (const GenericArray&)) PushBack(T value,
															 AllocatorType &allocator) const {
	value_.PushBack(value,
					allocator);
	return *this;
  ...
  ValueIterator Erase(ConstValueIterator first,
					  ConstValueIterator last) const { return value_.Erase(first, last); }
...
class GenericObject {
 public:
  ...
  template<typename SourceAllocator>
  ValueType &operator[](const GenericValue<EncodingType,
										   SourceAllocator> &name) const { return value_[name]; }
#if RAPIDJSON_HAS_STDSTRING
...
#endif
  template<typename SourceAllocator>
  bool HasMember(const GenericValue<EncodingType,
									SourceAllocator> &name) const { return value_.HasMember(name); }
  MemberIterator FindMember(const Ch *name) const { return value_.FindMember(name); }
  template<typename SourceAllocator>
  MemberIterator FindMember(const GenericValue<EncodingType,
											   SourceAllocator> &name) const {
...
#endif
  template<typename SourceAllocator>
  bool RemoveMember(const GenericValue<EncodingType,
									   SourceAllocator> &name) const {
  ...
  MemberIterator EraseMember(ConstMemberIterator first,
	...
	return value_.EraseMember(first,
							  last);
  }
...
#endif
  template<typename SourceAllocator>
  bool EraseMember(const GenericValue<EncodingType,
									  SourceAllocator> &name) const { return value_.EraseMember(name); }
