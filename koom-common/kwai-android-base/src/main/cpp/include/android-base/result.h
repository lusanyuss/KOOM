...
inline bool operator!=(const ResultError &lhs, const ResultError &rhs) { return !(lhs == rhs); }
...
inline Error ErrnoError() { return Error(errno); }

inline int ErrorCode(int code) { return code; }
