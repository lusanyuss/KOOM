...
class ProguardMappingReader(
    ...
    fun readProguardMapping(): ProguardMapping {
        ...
        proguardMappingInputStream.bufferedReader(Charsets.UTF_8).use { bufferedReader ->
            ...
            while (true) {
                ...
                if(line.isEmpty() || line.startsWith(HASH_SYMBOL)) { // empty line or comment
                    continue
                }
    ...
    private fun parseClassMapping(
        line: String, proguardMapping: ProguardMapping
    ): String? {
    ...
    private fun parseClassField(
        line: String, currentClassName: String, proguardMapping: ProguardMapping
    ) {
