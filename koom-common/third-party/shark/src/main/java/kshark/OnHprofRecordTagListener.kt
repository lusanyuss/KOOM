...
interface OnHprofRecordTagListener {
    fun onHprofRecord(
         ...
         */
        length: Long, reader: HprofRecordReader
    )
    ...
    companion object {
         ...
         * ```
         */
        inline operator fun invoke(crossinline block: (HprofRecordTag, Long, HprofRecordReader) -> Unit): OnHprofRecordTagListener = object : OnHprofRecordTagListener {
