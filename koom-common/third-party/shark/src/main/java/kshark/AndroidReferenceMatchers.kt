...
import kshark.AndroidReferenceMatchers.Companion.appDefaults
import kshark.AndroidReferenceMatchers.Companion.buildKnownReferences
...
enum class AndroidReferenceMatchers {
    ...
    ACTIVITY_CLIENT_RECORD__NEXT_IDLE {
        override fun add(
            ...
            references += instanceFieldLeak(
                ...
                "nextIdle",
                description = "Android AOSP sometimes keeps a reference to a destroyed activity as a" + " nextIdle client record in the android.app.ActivityThread.mActivities map." + " Not sure what's going on there, input welcome."
            ) {
                sdkInt in 19..27
            }
        }
    ...
    INPUT_METHOD_MANAGER_IS_TERRIBLE {
        override fun add(
            ...
            references += instanceFieldLeak(
                "android.view.inputmethod.InputMethodManager",
                "mCurRootView",
                description = "The singleton InputMethodManager is holding a reference to mCurRootView long" + " after the activity has been destroyed." + " Observed on ICS MR1: https://github.com/square/leakcanary/issues/1" + "#issuecomment-100579429" + " Hack: https://gist.github.com/pyricau/4df64341cc978a7de414"
            ) {
                sdkInt in 15..28
            }
            
            references += instanceFieldLeak(
                "android.view.inputmethod.InputMethodManager", "mImeInsetsConsumer", description = """
            ...
            references += instanceFieldLeak(
                "android.view.inputmethod.InputMethodManager", "mCurrentInputConnection", description = """
    ...
    LAYOUT_TRANSITION {
        override fun add(
            ...
            references += instanceFieldLeak(
                ...
                "val\$parent",
                description = "LayoutTransition leaks parent ViewGroup through" + " ViewTreeObserver.OnPreDrawListener When triggered, this leaks stays until the" + " window is destroyed. Tracked here:" + " https://code.google.com/p/android/issues/detail?id=171830"
            ) {
                sdkInt in 14..22
            }
        }
    ...
    SPELL_CHECKER_SESSION {
        override fun add(
            ...
            references += instanceFieldLeak(
                ...
                "this$0",
                description = "SpellCheckerSessionListenerImpl.mHandler is leaking destroyed Activity when the" + " SpellCheckerSession is closed before the service is connected." + " Tracked here: https://code.google.com/p/android/issues/detail?id=172542"
            ) {
                sdkInt in 16..24
            }
        }
    ...
    SPELL_CHECKER {
        override fun add(
            ...
            references += instanceFieldLeak(
                ...
                "this$0",
                description = "SpellChecker holds on to a detached view that points to a destroyed activity." + " mSpellRunnable is being enqueued, and that callback should be removed when " + " closeSession() is called. Maybe closeSession() wasn't called, or maybe it was " + " called after the view was detached."
            ) {
                sdkInt == 22
            }
        }
    ...
    ACTIVITY_CHOOSE_MODEL {
        override fun add(
            ...
            references += instanceFieldLeak(
                "android.support.v7.internal.widget.ActivityChooserModel", "mActivityChoserModelPolicy", description = description
            ) {
                sdkInt in 15..22
            }
            
            references += instanceFieldLeak(
                "android.widget.ActivityChooserModel", "mActivityChoserModelPolicy", description = description
            )
        }
    },
    ...
    MEDIA_PROJECTION_CALLBACK {
        override fun add(references: MutableList<ReferenceMatcher>) {
            references += instanceFieldLeak(
                "android.media.projection.MediaProjection\$MediaProjectionCallback", "this$0", description = """
    ...
    SPEECH_RECOGNIZER {
        override fun add(
            ...
            references += instanceFieldLeak(
                "android.speech.SpeechRecognizer\$InternalListener",
                "this$0",
                description = "Prior to Android 5, SpeechRecognizer.InternalListener was a non static inner" + " class and leaked the SpeechRecognizer which leaked an activity context." + " Fixed in AOSP: https://github.com/android/platform_frameworks_base/commit" + " /b37866db469e81aca534ff6186bdafd44352329b"
            ) {
                sdkInt < 21
            }
        }
    ...
    APP_WIDGET_HOST_CALLBACKS {
        override fun add(
            ...
            references += instanceFieldLeak(
                ...
                "this$0",
                description = "android.appwidget.AppWidgetHost\$Callbacks is a stub and is held in memory native" + " code. The reference to the `mContext` was not being cleared, which caused the" + " Callbacks instance to retain this reference" + " Fixed in AOSP: https://github.com/android/platform_frameworks_base/commit" + "/7a96f3c917e0001ee739b65da37b2fadec7d7765"
            ) {
                sdkInt < 22
            }
        }
    ...
    CONNECTIVITY_MANAGER__SINSTANCE {
        override fun add(
            ...
            references += instanceFieldLeak(
                ...
                "sInstance",
                description = "ConnectivityManager has a sInstance field that is set when the first" + " ConnectivityManager instance is created. ConnectivityManager has a mContext field." + " When calling activity.getSystemService(Context.CONNECTIVITY_SERVICE) , the first" + " ConnectivityManager instance is created with the activity context and stored in" + " sInstance. That activity context then leaks forever." + " Until this is fixed, app developers can prevent this leak by making sure the" + " ConnectivityManager is first created with an App Context. E.g. in some static" + " init do: context.getApplicationContext()" + ".getSystemService(Context.CONNECTIVITY_SERVICE)" + " Tracked here: https://code.google.com/p/android/issues/detail?id=198852" + " Introduced here: https://github.com/android/platform_frameworks_base/commit/" + "e0bef71662d81caaaa0d7214fb0bef5d39996a69"
            ) {
                sdkInt <= 23
            }
        }
    ...
    ACCESSIBILITY_ITERATORS {
        override fun add(references: MutableList<ReferenceMatcher>) {
            references += instanceFieldLeak(
                "android.widget.AccessibilityIterators\$LineTextSegmentIterator",
                "mLayout",
                description = "AccessibilityIterators holds on to text layouts which can hold on to spans" + " TextView.ChangeWatcher and android.widget.Editor end up in spans and" + " typically hold on to the view hierarchy"
            ) {
                sdkInt == 27
            }
        }
    ...
    BIOMETRIC_PROMPT {
        override fun add(references: MutableList<ReferenceMatcher>) {
            references += instanceFieldLeak(
                "android.hardware.biometrics.BiometricPrompt", "mFingerprintManager", description = "BiometricPrompt holds on to a FingerprintManager which holds on to a " + "destroyed activity."
            ) {
                sdkInt == 28
            }
        }
    ...
    BACKDROP_FRAME_RENDERER__MDECORVIEW {
        override fun add(
            ...
            references += instanceFieldLeak(
                ...
                "mDecorView",
                description = "When BackdropFrameRenderer.releaseRenderer() is called, there's an unknown case" + " where mRenderer becomes null but mChoreographer doesn't and the thread doesn't" + " stop and ends up leaking mDecorView which itself holds on to a destroyed" + " activity"
            ) {
                sdkInt in 24..26
            }
        }
    ...
    ACCESSIBILITY_NODE_ID_MANAGER {
        override fun add(references: MutableList<ReferenceMatcher>) {
            references += instanceFieldLeak(
                "android.view.accessibility.AccessibilityNodeIdManager", "mIdsToViews", description = """
    ...
    CONTROLLED_INPUT_CONNECTION_WRAPPER {
        override fun add(references: MutableList<ReferenceMatcher>) {
            references += nativeGlobalVariableLeak(
                "android.view.inputmethod.InputMethodManager\$ControlledInputConnectionWrapper", description = """
    ...
    TOAST_TN {
        override fun add(references: MutableList<ReferenceMatcher>) {
            references += nativeGlobalVariableLeak(
                "android.widget.Toast\$TN", description = """
    ...
    APPLICATION_PACKAGE_MANAGER__HAS_SYSTEM_FEATURE_QUERY {
        override fun add(references: MutableList<ReferenceMatcher>) {
            references += instanceFieldLeak(
                "android.app.ApplicationPackageManager\$HasSystemFeatureQuery", "this\$0", description = """
    ...
    SPEN_GESTURE_MANAGER {
        override fun add(
            ...
            references += staticFieldLeak(
                "com.samsung.android.smartclip.SpenGestureManager",
                "mContext",
    ...
    CLIPBOARD_UI_MANAGER__SINSTANCE {
        override fun add(
            ...
            references += instanceFieldLeak(
                ...
                "mContext",
                description = "ClipboardUIManager is a static singleton that leaks an activity context." + " Fix: trigger a call to ClipboardUIManager.getInstance() in Application.onCreate()" + " , so that the ClipboardUIManager instance gets cached with a reference to the" + " application context. Example: https://gist.github.com/cypressious/" + "91c4fb1455470d803a602838dfcd5774"
            ) {
    ...
    CLIPBOARD_EX_MANAGER {
        override fun add(
            ...
            references += instanceFieldLeak(
                "android.sec.clipboard.ClipboardExManager",
                "mContext",
                description = "android.sec.clipboard.ClipboardExManager\$IClipboardDataPasteEventImpl\$1" + " is a native callback that holds IClipboardDataPasteEventImpl which holds" + " ClipboardExManager which has a destroyed activity as mContext"
            ) {
            ...
            references += instanceFieldLeak(
                "android.sec.clipboard.ClipboardExManager",
                "mPersonaManager",
                description = "android.sec.clipboard.ClipboardExManager\$IClipboardDataPasteEventImpl\$1" + " is a native callback that holds IClipboardDataPasteEventImpl which holds" + " ClipboardExManager which holds PersonaManager which has a destroyed activity as" + " mContext"
            ) {
                manufacturer == SAMSUNG && sdkInt == 23
            }
            references += instanceFieldLeak(
                ...
                "this\$0",
                description = "TextView\$IClipboardDataPasteEventImpl\$1 is held by a native ref, and" + " IClipboardDataPasteEventImpl ends up leaking a detached textview"
            ) {
    ...
    SEM_EMERGENCY_MANAGER__MCONTEXT {
        override fun add(
            ...
            references += instanceFieldLeak(
                ...
                "mContext",
                description = "SemEmergencyManager is a static singleton that leaks a DecorContext." + " Fix: https://gist.github.com/jankovd/a210460b814c04d500eb12025902d60d"
            ) {
    ...
    TEXT_VIEW__MLAST_HOVERED_VIEW {
        override fun add(
            ...
            references += staticFieldLeak(
                "android.widget.TextView", "mLastHoveredView", description = "mLastHoveredView is a static field in TextView that leaks the last hovered" + " view."
            ) {
    ...
    PERSONA_MANAGER {
        override fun add(
            ...
            references += instanceFieldLeak(
                "android.os.PersonaManager",
                "mContext",
                description = "android.app.LoadedApk.mResources has a reference to" + " android.content.res.Resources.mPersonaManager which has a reference to" + " android.os.PersonaManager.mContext which is an activity."
            ) {
                manufacturer == SAMSUNG && sdkInt == 19
            }
        }
    ...
    RESOURCES__MCONTEXT {
        override fun add(
            ...
            references += instanceFieldLeak(
                ...
                "mContext",
                description = "In AOSP the Resources class does not have a context." + " Here we have ZygoteInit.mResources (static field) holding on to a Resources" + " instance that has a context that is the activity." + " Observed here: https://github.com/square/leakcanary/issues/1#issue-74450184"
            ) {
                manufacturer == SAMSUNG && sdkInt == 19
            }
        }
    ...
    VIEW_CONFIGURATION__MCONTEXT {
        override fun add(
            ...
            references += instanceFieldLeak(
                ...
                "mContext",
                description = "In AOSP the ViewConfiguration class does not have a context." + " Here we have ViewConfiguration.sConfigurations (static field) holding on to a" + " ViewConfiguration instance that has a context that is the activity." + " Observed here: https://github.com/square/leakcanary/issues" + "/1#issuecomment-100324683"
            ) {
                manufacturer == SAMSUNG && sdkInt == 19
            }
        }
    ...
    AUDIO_MANAGER__MCONTEXT_STATIC {
        override fun add(
            ...
            references += staticFieldLeak(
                ...
                "mContext_static",
                description = "Samsung added a static mContext_static field to AudioManager, holds a reference" + " to the activity." + " Observed here: https://github.com/square/leakcanary/issues/32"
            ) {
                manufacturer == SAMSUNG && sdkInt == 19
            }
        }
    ...
    ACTIVITY_MANAGER_MCONTEXT {
        override fun add(
            ...
            references += staticFieldLeak(
                ...
                "mContext",
                description = "Samsung added a static mContext field to ActivityManager, holds a reference" + " to the activity." + " Observed here: https://github.com/square/leakcanary/issues/177 Fix in comment:" + " https://github.com/square/leakcanary/issues/177#issuecomment-222724283"
            ) {
    ...
    STATIC_MTARGET_VIEW {
        override fun add(
            ...
            references += staticFieldLeak(
                "android.widget.TextView", "mTargetView", description = "Samsung added a static mTargetView field to TextView which holds on to detached views."
            ) {
    ...
    MULTI_WINDOW_DECOR_SUPPORT__MWINDOW {
        override fun add(
            ...
            references += instanceFieldLeak(
                "com.android.internal.policy.MultiWindowDecorSupport", "mWindow", description = """DecorView isn't leaking but its mDecorViewSupport field holds
    ...
    GESTURE_BOOST_MANAGER {
        override fun add(
            ...
            references += staticFieldLeak(
                ...
                "mContext",
                description = "GestureBoostManager is a static singleton that leaks an activity context." + " Fix: https://github.com/square/leakcanary/issues/696#issuecomment-296420756"
            ) {
    ...
    BUBBLE_POPUP_HELPER__SHELPER {
        override fun add(
            ...
            references += staticFieldLeak(
                "android.widget.BubblePopupHelper", "sHelper", description = "A static helper for EditText bubble popups leaks a reference to the latest" + " focused view."
            ) {
    ...
    LGCONTEXT__MCONTEXT {
        override fun add(
            ...
            references += instanceFieldLeak(
                "com.lge.systemservice.core.LGContext", "mContext", description = "LGContext is a static singleton that leaks an activity context."
            ) {
    ...
    SMART_COVER_MANAGER {
        override fun add(
            ...
            references += instanceFieldLeak(
                "com.lge.systemservice.core.SmartCoverManager",
                "mContext",
                description = "SmartCoverManager\$CallbackRegister is a callback held by a native ref," + " and SmartCoverManager ends up leaking an activity context."
            ) {
    ...
    MAPPER_CLIENT {
        override fun add(
            ...
            references += instanceFieldLeak(
                "com.nvidia.ControllerMapper.MapperClient\$ServiceClient",
                "this$0",
                description = "Not sure exactly what ControllerMapper is about, but there is an anonymous" + " Handler in ControllerMapper.MapperClient.ServiceClient, which leaks" + " ControllerMapper.MapperClient which leaks the activity context."
            ) {
    ...
    SYSTEM_SENSOR_MANAGER__MAPPCONTEXTIMPL {
        override fun add(
            ...
            references += staticFieldLeak(
                ...
                "mAppContextImpl",
                description = "SystemSensorManager stores a reference to context" + " in a static field in its constructor." + " Fix: use application context to get SensorManager"
            ) {
    ...
    INSTRUMENTATION_RECOMMEND_ACTIVITY {
        override fun add(
            ...
            references += staticFieldLeak(
                ...
                "mRecommendActivity",
                description = "Instrumentation would leak com.android.internal.app.RecommendActivity (in" + " framework.jar) in Meizu FlymeOS 4.5 and above, which is based on Android 5.0 and " + " above"
            ) {
    ...
    DEVICE_POLICY_MANAGER__SETTINGS_OBSERVER {
        override fun add(
            ...
            references += instanceFieldLeak(
                ...
                "this$0",
                description = "DevicePolicyManager keeps a reference to the context it has been created with" + " instead of extracting the application context. In this Motorola build," + " DevicePolicyManager has an inner SettingsObserver class that is a content" + " observer, which is held into memory by a binder transport object."
            ) {
    ...
    EXTENDED_STATUS_BAR_MANAGER {
        override fun add(
            ...
            references += staticFieldLeak(
                "android.app.ExtendedStatusBarManager", "sInstance", description = """
    ...
    OEM_SCENE_CALL_BLOCKER {
        override fun add(
            ...
            references += staticFieldLeak(
                "com.oneplus.util.OemSceneCallBlocker", "sContext", description = """
    ...
    RAZER_TEXT_KEY_LISTENER__MCONTEXT {
        override fun add(
            ...
            references += instanceFieldLeak(
                "android.text.method.TextKeyListener", "mContext", description = """
    ...
    LEAK_CANARY_HEAP_DUMPER {
        override fun add(references: MutableList<ReferenceMatcher>) { // Holds on to the resumed activity (which is never destroyed), so this will not cause leaks
    ...
    companion object {
        ...
        val ignoredReferencesOnly: List<ReferenceMatcher>
            get() = buildKnownReferences(
                EnumSet.of(
                    REFERENCES, FINALIZER_WATCHDOG_DAEMON, MAIN, LEAK_CANARY_THREAD, EVENT_RECEIVER__MMESSAGE_QUEUE
                )
            )
        ...
        @JvmStatic
        fun staticFieldLeak(
            className: String, fieldName: String, description: String = "", patternApplies: AndroidBuildMirror.() -> Boolean = ALWAYS
        ): LibraryLeakReferenceMatcher {
        ...
        fun nativeGlobalVariableLeak(
            className: String, description: String = "", patternApplies: AndroidBuildMirror.() -> Boolean = ALWAYS
        ): LibraryLeakReferenceMatcher {
            return libraryLeak(NativeGlobalVariablePattern(className), description, patternApplies)
        }
        
        private fun libraryLeak(
            referencePattern: ReferencePattern, description: String, patternApplies: AndroidBuildMirror.() -> Boolean
        ): LibraryLeakReferenceMatcher {
            return LibraryLeakReferenceMatcher(pattern = referencePattern, description = description, patternApplies = { graph ->
