...
import kshark.LeakTrace.Companion.ZERO_WIDTH_SPACE
...
data class LeakTraceObject(
    val objectId: Long, //Added by Kwai.
    val type: ObjectType,
    /**
     ...
     */
    val labels: Set<String>, val leakingStatus: LeakingStatus, var leakingStatusReason: String,
    /**
    ...
    internal fun toString(
        firstLinePrefix: String, additionalLinesPrefix: String, showLeakingStatus: Boolean, typeName: String = this.typeName
    ): String {
