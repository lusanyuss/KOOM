...
sealed class GcRoot {
     ...
     */
    class JniGlobal(
        override val id: Long, val jniGlobalRefId: Long
    ) : GcRoot()
     ...
     */
    class ThreadObject(
        override val id: Long, val threadSerialNumber: Int, val stackTraceSerialNumber: Int
    ) : GcRoot()
     ...
     */
    class JniMonitor(
        override val id: Long, val stackTraceSerialNumber: Int, val stackDepth: Int
    ) : GcRoot()
