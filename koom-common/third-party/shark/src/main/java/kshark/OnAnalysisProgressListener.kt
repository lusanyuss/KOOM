...
fun interface OnAnalysisProgressListener {
    ...
    enum class Step {
        PARSING_HEAP_DUMP, EXTRACTING_METADATA, FINDING_RETAINED_OBJECTS, FINDING_PATHS_TO_RETAINED_OBJECTS, FINDING_DOMINATORS, INSPECTING_OBJECTS, COMPUTING_NATIVE_RETAINED_SIZE, COMPUTING_RETAINED_SIZE, BUILDING_LEAK_TRACES, REPORTING_HEAP_ANALYSIS
    }
    ...
    companion object {
         ...
         * ```
         */
        inline operator fun invoke(crossinline block: (Step) -> Unit): OnAnalysisProgressListener = object : OnAnalysisProgressListener {
