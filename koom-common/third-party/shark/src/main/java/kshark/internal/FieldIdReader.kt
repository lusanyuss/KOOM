...
internal class FieldIdReader(
    private val record: InstanceDumpRecord, private val identifierByteSize: Int
) {
    ...
    private fun readShortId(
        ...
        var pos = index
        return (array[pos++] and 0xff shl 8 or (array[pos] and 0xff)).toLong()
    }
    ...
    private fun readIntId(
        ...
        var pos = index
        return (array[pos++] and 0xff shl 24 or (array[pos++] and 0xff shl 16) or (array[pos++] and 0xff shl 8) or (array[pos] and 0xff)).toLong()
    }
